...
public class OrderBookingScreen extends BaseActvitvityForDrawer {
   ...
   // private Spinner sp_time_slots;
    ...
    private void spPickupSpinnerClick() {
        ...
        sp_pickup.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //
                if (selectedCity.equals("Loralai") || selectedCity.equals("Zhop") || selectedCity.equals("Killa Saifullah")
    ...
    private void settingItemClickListnerOnDropoffCity() {
        ...
        sp_dropoff.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
               ...
               else if ((selectedCity.equals("Quetta") && picupCity.equals("Zhop")) || (selectedCity.equals("Zhop") && picupCity.equals("Quetta"))) {
               ...
               else if ((selectedCity.equals("Quetta") && picupCity.equals("Killa Saifullah")) || (selectedCity.equals("Killa Saifullah") && picupCity.equals("Quetta"))) {
    ...
    private String FareEstimation(String spPickCity, String spDropoff, String spCartype, String spSeates){
        ...
        //***********************************************************************************//
        //************Zhop to Quetta and Quetta to Zhop Rates *********************//
        //**********************************************************************************//
        //business class
        if (spPickCity.equals("Zhop") && spDropoff.equals("Quetta") && spCartype.equals("Business") && spSeates.equals("1")){
            mEstimateFare = "Rs.1500";
        }
        if (spPickCity.equals("Zhop") && spDropoff.equals("Quetta") && spCartype.equals("Business") && spSeates.equals("2")){
            mEstimateFare = "Rs.3000";
        }
        if (spPickCity.equals("Zhop") && spDropoff.equals("Quetta") && spCartype.equals("Business") && spSeates.equals("3")){
            mEstimateFare = "Rs.4500";
        }

        if (spPickCity.equals("Quetta") && spDropoff.equals("Zhop") && spCartype.equals("Business") && spSeates.equals("1")){
            mEstimateFare = "Rs.1500";
        }
        if (spPickCity.equals("Quetta") && spDropoff.equals("Zhop") && spCartype.equals("Business") && spSeates.equals("2")){
            mEstimateFare = "Rs.3000";
        }
        if (spPickCity.equals("Quetta") && spDropoff.equals("Zhop") && spCartype.equals("Business") && spSeates.equals("3")){
            mEstimateFare = "Rs.4500";
        }


        //***********************************************************************************//
        //************Killa Saifullah to Quetta and Quetta to Killa Saifullah Rates *********************//
        //**********************************************************************************//
        //business class
        if (spPickCity.equals("Killa Saifullah") && spDropoff.equals("Quetta") && spCartype.equals("Business") && spSeates.equals("1")){
            mEstimateFare = "Rs.1500";
        }
        if (spPickCity.equals("Killa Saifullah") && spDropoff.equals("Quetta") && spCartype.equals("Business") && spSeates.equals("2")){
            mEstimateFare = "Rs.3000";
        }
        if (spPickCity.equals("Killa Saifullah") && spDropoff.equals("Quetta") && spCartype.equals("Business") && spSeates.equals("3")){
            mEstimateFare = "Rs.4500";
        }

        if (spPickCity.equals("Quetta") && spDropoff.equals("Killa Saifullah") && spCartype.equals("Business") && spSeates.equals("1")){
            mEstimateFare = "Rs.1500";
        }
        if (spPickCity.equals("Quetta") && spDropoff.equals("Killa Saifullah") && spCartype.equals("Business") && spSeates.equals("2")){
            mEstimateFare = "Rs.3000";
        }
        if (spPickCity.equals("Quetta") && spDropoff.equals("Killa Saifullah") && spCartype.equals("Business") && spSeates.equals("3")){
            mEstimateFare = "Rs.4500";
        }
